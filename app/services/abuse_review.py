...
class AbuseReviewService:
    ...
    async def report(
        ...
        pairing_page_candidates = pairing_candidates[
            (pairing_page - 1) * pair_page_size : pairing_page * pair_page_size
        ]
        combined_page_candidates = combined_candidates[
            (combined_page - 1) * pair_page_size : combined_page * pair_page_size
        ]
        parent: dict[str, str] = {}
